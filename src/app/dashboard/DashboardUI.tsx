        ...
        {tickerData && !loading && (
          <>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold">{tickerData.ticker}</h1>
            ...
            <Tabs defaultValue="keystats" className="w-full">
              ...
              <TabsContent value="keystats" className="flex flex-col gap-4">
              ...
              <TabsContent value="chat">Chat with an Agent</TabsContent>
            </Tabs>
          </>
        )}
      </div>
